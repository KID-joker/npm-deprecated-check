...
test('package tests', async (t) => {
  await t.test('check it that deprecated package gets detected', (_t, done) => {
  ...
  await t.test('check it that not deprecated package does not get detected as deprecated', (_t, done) => {
